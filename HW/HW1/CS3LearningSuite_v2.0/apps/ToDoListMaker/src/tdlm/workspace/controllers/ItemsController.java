...
public class ItemsController {
    ...
    public void processAddItem() {
        ...
        //
        if (newItem != null || newItem.getCategory() != null || newItem.getDescription() != null) {
            // IF IT HAS A UNIQUE NAME AND COLOR
            // THEN CREATE A TRANSACTION FOR IT
            // AND ADD IT
            ToDoData data = (ToDoData) app.getDataComponent();
            if (data.isValidNewToDoItem(newItem.getCategory(), newItem.getDescription(), newItem.getStartDate(), newItem.getStartDate(), true)) {
